...
Route::middleware(['auth'])->group(function () {
    Route::get('/debtors', [UserDebtController::class, 'index'])->name('debtors.index');
    Route::post('/users/{user}/clear-debit', [UserDebtController::class, 'clear'])->name('debtors.clear');
});
