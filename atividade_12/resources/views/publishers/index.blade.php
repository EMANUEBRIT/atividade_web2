...
@section('content')
<div class="container">
    <h1 class="my-4">Lista de Publicação</h1>
    ...
    <table class="table table-striped">
        ...
        <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('publishers.destroy', $publisher) }}" method="POST" style="display: inline;">
                            @csrf
                            @method('DELETE')
                            <button class="btn btn-danger btn-sm" onclick="return confirm('Deseja excluir esta publicação?')">
            ...
            @empty
                <tr>
                    <td colspan="3">Nenhuma publicação encontrada.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
